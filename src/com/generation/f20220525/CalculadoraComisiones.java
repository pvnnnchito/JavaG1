...
public class CalculadoraComisiones {
	...
	public static void main(String[] args) {
		...
		if (edadPersona > 0) {
			if (edadPersona < edadMayor && edadPersona > edadMenor) {// Si la edad de la persona esta entra los 16 y 60
																		// años su ticket es de 3500
				...
				System.out.println("Su ticket tiene un 60% de descuento");// si la edad de la persona es menor a los 16
																			// años su ticket tiene un descuento del 60%
				float descuento60 = precioTicket * descuentoMinimo; // este sera el monto que se descuenta a normal a
																	// los menores iguales a 15 años
				// se tendra que restar descuento60 de precio ticket para que entregue el valor
				// final con dcto aplicado
				// no se si será float
				float finalMinimo = precioTicket - descuento60; // lo que devolvera sera el 40% del precio de entrada
																// normal, lo que se debera pagar
				System.out.println("Su precio final es de " + finalMinimo);

			} else if (edadPersona > edadMayor) {
				System.out.println("Su ticket tiene un 55% de descuento");// si la edad de la persona es mayor a 60 años
																			// su ticket tiene un descuento del 55%
				float descuento55 = precioTicket * descuentoMayores; // este sera el monto que se descuenta a normal a
																		// los mayores de 60(excluyendo 60)
				// desconozco si corresponde un float aqui
				float finalMayores = precioTicket - descuento55; // lo que devolvera sera el 45% restante de la entrada,
																	// que sera el monto a pagar
