...
public class Main {
	...
	public static void main(String[] args) {
		...
		try {
			...
			System.out.println("Ha ocurrido un error, contecte al administrador " );
		}
		...
		/**acceder al metodo desde otra clase**/
		//instancia de la clase
		
		ClienteManager cm = new ClienteManager(); // creamos la instancia, o sea estamos invocando 
		cm.recorrerArregloCliente(listaCliente);  // llamar al metodo 
